...
class TransportationOrder(models.Model):
    ...
    load_place = models.OneToOneField(LoadPlace, on_delete = models.PROTECT)
...
class Delivery(models.Model):
    ...
    def __str__(self):
        return f"Delivery place: {self.country} - {self.state} - {self.town} {self.postal_code}, st. {self.street} {self.street_number}, Contact: {self.contact_number}, Cargo: {self.cargo_weight}t."
